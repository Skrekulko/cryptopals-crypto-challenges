...
from helper_c38 import SHA1, mod_pow
...
def dictionary_attack_password(s: int, I: int, g: int, N: int, v: int) -> int:
    # Dictionary
...
def client_c38(server_address = srp_address) -> None:
    ...
    # Get The Password 'P'
    P = dictionary_attack_password(s, I, g, N, response.json().get("v"))
