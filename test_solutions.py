...
def test_s01_c02() -> None:
    ...
    assert s01_c02(input1, input2) == result
...
def test_s01_c05() -> None:
    ...
    assert s01_c05(input, key) == result
    
#
#   06 - Break repeating-key XOR
#

from solutions import s01_c06
def test_s01_c06() -> None:
    ...
    assert s01_c06(file_name) == (result_plaintext, result_key)
    
#
#   07 - AES in ECB mode
#

from solutions import s01_c07
def test_s01_c07() -> None:
    file_name = "files/7.txt"
    key = b"YELLOW SUBMARINE"
    result = b"I'm back and I'm ringin' the bell \nA rockin' on the mike while the fly girls yell \nIn ecstasy in the back of me \nWell that's my DJ Deshay cuttin' all them Z's \nHittin' hard and the girlies goin' crazy \nVanilla's on the mike, man I'm not lazy. \n\nI'm lettin'"
    
    assert s01_c07(file_name, key) == result
 
#
#   08 - Detect AES in ECB mode
#

from solutions import s01_c08
def test_s01_c08() -> None:
    file_name = "files/8.txt"
    result = True
    
    assert s01_c08(file_name) == result
    
#
#   09 - Implement PKCS#7 padding
#

from solutions import s02_c01
def test_s02_c01() -> None:
    input = b"YELLOW SUBMARINE"
    block_size = 20
    result = b"YELLOW SUBMARINE\x04\x04\x04\x04"
    
    assert s02_c01(input, block_size) == result
    
#
#   10 - Implement CBC mode
#

from solutions import s02_c02
def test_s02_c02() -> None:
    ...
    assert s02_c02(file_name, key, iv) == result

#
#   11 - An ECB/CBC detection oracle
#

from solutions import s02_c03
def test_s02_c03() -> None:
    input = b"A" * 50
    result = s02_c03(input)
...
def test_s02_c04() -> None:
    ...
    assert s02_c04() == result
    
#
#   13 - ECB cut-and-paste
#

from solutions import s02_c05
def test_s02_c05() -> None:
    result = b"email=AAAAAAAAAAAAA&uid=10&role=admin"

    assert s02_c05() == result
    
#
#   14 - Byte-at-a-time ECB decryption (Harder)
#

from solutions import s02_c06
def test_s02_c06() -> None:
    result = b"Um9sbGluJyBpbiBteSA1LjAKV2l0aCBteSByYWctdG9wIGRvd24gc28gbXkgaGFpciBjYW4gYmxvdwpUaGUgZ2lybGllcyBvbiBzdGFuZGJ5IHdhdmluZyBqdXN0IHRvIHNheSBoaQpEaWQgeW91IHN0b3A/IE5vLCBJIGp1c3QgZHJvdmUgYnkK"
    
    assert s02_c06() == result

#
#   15 - PKCS#7 padding validation
#

from solutions import s02_c07
def test_s02_c07() -> None:
    ...
    with pytest.raises(ValueError):
        s02_c07(input_incorrect_1)
        
    with pytest.raises(ValueError):
        s02_c07(input_incorrect_2)
    
    assert s02_c07(input) == result
